...
<div class="container">
<div class="container">
  <form action="/categorie/categorielist">
  <?php
$title = "Ajouter une page";
$this->assign('h1_title', $title);
echo '<br/>';
echo '<br/>';
echo $this->Form->create($this->categorie);
// Hard code the user for now.
echo $this->Form->control('id', ['type' => 'hidden', 'value' => 1]);
echo $this->Form->control('label');
echo $this->Form->control('image_url');
echo '<br/>';
echo $this->Form->button(__('Sauvegarder page'));
echo $this->Form->end();
?>
  ...
  <!-- <div class="row">
    <div class="col-25">
      <label style="font-size:large; color:black">Nom de la catégorie</label>
    </div>
    <div class="col-75">
      <input type="text">
    </div>
    <div class="col-25">
      <label style="font-size:large; color:black">Image de la catégorie</label>
    </div>
    <div class="col-75">
    ...
    <br>
  <div class="row">
    <input type="submit" value="<?echo $this->Form->button(__('Submit'));
    echo $this->Form->end();?>">
  </div>
  </form>
</div>
